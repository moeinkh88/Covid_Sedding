# This code is for fitting parameters Λ,μ,μp,ϕ1,ϕ2,β1,β2,δ,ψ,ω,σ,γS,γA,ηS,ηA when others parameters are obtained from bounded initial fitting
...
function loss(args)
	...
	Order[1:6]=args[1:6]
	Λ,μ,μp,ϕ1,ϕ2,β1,β2,δ,ψ,ω,σ,γS,γA,ηS,ηA = args[7:21]
...
p_lo_1=vcat(.4*ones(6),1,.00001*ones(14)) #lower bound
p_up_1=vcat(ones(6),222,2*ones(14)) # upper bound
p_vec_1=vcat(.99*ones(6),Λ,μ,μp,ϕ1,ϕ2,β1,β2,δ,ψ,ω,σ,γS,γA,ηS,ηA)
