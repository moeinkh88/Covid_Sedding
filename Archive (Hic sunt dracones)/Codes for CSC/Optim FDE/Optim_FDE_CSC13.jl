# This code is for fitting parameters β1,β2,ηS,ϕ1 when others parameters are obtained from unbounded initial fitting
...
p_lo_1=vcat(.4*ones(6),1e-5*ones(4)) #lower bound
p_up_1=vcat(ones(6),ones(4)) # upper bound
p_vec_1=vcat(.99*ones(6),.001*ones(4))
