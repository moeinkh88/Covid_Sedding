# This code is for fitting parameters Λ,δ,γA  when others parameters are obtained from unbounded initial fitting
...
p_up_1=vcat(ones(6),222,ones(2)) # upper bound
p_vec_1=vcat(.99*ones(6),Λ,δ,ηA)
