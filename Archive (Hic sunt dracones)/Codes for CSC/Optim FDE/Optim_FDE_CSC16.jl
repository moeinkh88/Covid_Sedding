# This code is for fitting parameters ϕ1,ϕ2,β1,β2,δ,ηS,ηA when others parameters are obtained from unbounded initial fitting
...
p_lo_1=vcat(.5*ones(6),1e-5*ones(7)) #lower bound
p_up_1=vcat(ones(6),ones(7)) # upper bound
p_vec_1=vcat(.99*ones(6),.001,ϕ2,.001,.001,δ,.001,ηA)

print("ϕ1,ϕ2,β1,β2,δ,ηS,ηA")
