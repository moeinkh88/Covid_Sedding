# This code is for fitting parameters ϕ1,β1,β2,ηS  when others parameters are obtained from unbounded initial fitting
...
p_lo_1=vcat(.5*ones(6),1e-10*ones(4)) #lower bound
p_up_1=vcat(ones(6),2*ones(4)) # upper bound
p_vec_1=vcat(.99999*ones(6),ϕ1,β1,β2,ηS)
