# This code is for fitting parameters ϕ2,δ,ω,γA when others parameters are obtained from fixed initial fitting
...
p_vec_1=vcat(.99*ones(6),ϕ2,δ,ω,γA)

print("ϕ1,ηS,β1,β2=1e-5,fit-> ϕ2,δ,ω,γA")
