...
@model function fitprob(data,prob)
	...
	RR=x[6,:]
	DD=x[8,:]
	add1=II[50]*ones(Ndays)
	add2=II[110]*ones(Ndays)
	add3=II[180]*ones(Ndays)
	add4=RR[120]*ones(Ndays)
	add5=RR[125]*ones(Ndays)
...
model = fitprob([C C[50]*ones(Ndays) C[110]*ones(Ndays) C[180]*ones(Ndays) TrueR TrueR[120]*ones(Ndays) TrueR[125]*ones(Ndays) TrueR[180]*ones(Ndays) TrueD],prob)
