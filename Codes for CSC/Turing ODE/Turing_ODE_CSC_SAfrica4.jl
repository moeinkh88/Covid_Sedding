...
@model function fitprob(data,prob)
    ...
    Λ ~ truncated(Normal(1, 3000); lower=1, upper=3000)
	μp ~ truncated(Normal(0, 1); lower=0, upper=1)
	ϕ1 ~ truncated(Normal(0, 1); lower=0, upper=1)
	ϕ2 ~ truncated(Normal(0, 1); lower=0, upper=1)
	...
	σ2 ~ truncated(Normal(0, 1); lower=0, upper=1)
	γS ~ truncated(Normal(0, 1); lower=0, upper=1)
	γA ~ truncated(Normal(0, 1); lower=0, upper=1)
	ηS ~ truncated(Normal(0, 1); lower=0, upper=1)
	ηA ~ truncated(Normal(0, 1); lower=0, upper=1)
	IA0 ~ truncated(Normal(0,1000); lower=0, upper=1000)
	P0 ~ truncated(Normal(0,1000); lower=0, upper=1000)
