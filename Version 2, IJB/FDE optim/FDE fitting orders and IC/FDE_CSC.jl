...
# This code optimize the order of derivatives and initial conditions
...
p_lo_1=vcat(.7*ones(7),30000,0,0,0) #lower bound
p_up_1=vcat(ones(7),900000,400,400,400) # upper bound
p_vec_1=vcat(.99999*ones(7),S0, E0, IA0, P0)
